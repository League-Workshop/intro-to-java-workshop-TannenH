...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	maze = ImageIO.read(getClass().getResource("Maze step 1.png"));
	...
	public void mouseMoved(MouseEvent e) {
		...
		int BGColor =  -14244198;
		
		int finishColor = -390646;
	...
	private void scare() {
		...
		showScaryImage("iStock_378181781200x813-1024x694(1).jpg");
